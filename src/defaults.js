...
module.exports = {
	 ...
	 */
	persistency: {
		prefix: function(wdqsr) {
			return "wdqsr_" + $(wdqsr.container).closest('[id]').attr('id') + "_";
		},
		/**
		...
		results: {
			 ...
			 */
			id: function(wdqsr) {
				return "results_" + $(wdqsr.container).closest('[id]').attr('id');
			},
			key: 'results',
			/**
